...
namespace Mastermind
{
    internal class Program
    {
        ...
        static int[] urna = new int[10];  //urna per estrazione numeri da indovinare
        ...
        #region input
        static int[] getints() //legge una stringa di 4 cifre e ritorna un array di interi contentente le cifre stesse
        {
            int[] numeri_inseriti = new int[4];
            while (true)
            {
                Console.Write("Inserisci i numeri in questo formato: XXXX --> "); //messaggio a video
        ...
        #region stampa risultati e menù
        static void stampaRisultati(byte[] risultati, int[] numeri_inseriti) //stampa risultati
        {
            ...
            //messaggio finale
            Console.WriteLine("\nDei numeri inseriti:");
            Console.ForegroundColor = ConsoleColor.Green;                                                           //numeri indovinati
            Console.WriteLine($"> {numeri_indovinati} sono corretti;");
            Console.ForegroundColor = ConsoleColor.Yellow;                                                          //numeri semi-indovinati
            Console.WriteLine($"> {numeri_semi_indovinati} sono nella posizione sbagliata;");
            Console.ForegroundColor = ConsoleColor.Red;                                                             //numeri non indovinati
            Console.WriteLine($"> {4 - numeri_indovinati - numeri_semi_indovinati} sono completamente sbagliati.");
